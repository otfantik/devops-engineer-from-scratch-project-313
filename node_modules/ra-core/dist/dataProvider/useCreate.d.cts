...
import type { RaRecord, CreateParams, Identifier, DataProvider, MutationMode } from "../types.cjs";
/**
 ...
 *                    \-- data is Product
 */
export declare const useCreate: <RecordType extends Omit<RaRecord, "id"> = any, MutationError = unknown, ResultRecordType extends RaRecord = RecordType & {
    id: Identifier;
