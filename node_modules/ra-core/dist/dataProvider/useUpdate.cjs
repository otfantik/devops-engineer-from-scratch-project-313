 ...
 *                    \-- data is Product
 */
const useUpdate = (resource, params = {}, options = {}) => {
    ...
    const dataProviderUpdate = (0, util_1.useEvent)((resource, params) => dataProvider.update(resource, params));
    ...
    const update = (0, util_1.useEvent)((callTimeResource = resource, callTimeParams = {}, callTimeOptions = {}) => {
        return mutate({
